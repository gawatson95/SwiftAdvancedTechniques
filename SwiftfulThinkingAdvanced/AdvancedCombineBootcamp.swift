...
//            })
            ...
            //.replaceNil(with: 5) use with optionals where value could be nil
           // replaceEmpty(with: 5) use with things like empty arrays
...
//            .reduce(0, +)
        ...
        */
        ...
        /*
            ...
            //.measureInterval(using: DispatchQueue.main) used for debugging
//            .map({ stride in
//                return "\(stride.timeInterval)"
//            })
            //.throttle(for: 5, scheduler: DispatchQueue.main, latest: true)
            //.retry(3) retries x times if error
...
struct AdvancedCombineBootcamp: View {
    ...
    @StateObject private var vm = AdvancedCombineBootcampVM()
